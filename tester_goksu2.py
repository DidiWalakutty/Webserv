...
def test_siege_suite():
    ...
    for label, cmd in scenarios:
        ...
        # Parse availability from siege's JSON stdout: "availability": 100.00
        import re
        m = re.search(r'"availability":\s*([\d.]+)', result.stdout)
        if m:
            ...
            passed(label + " (availability not found in siege output)")
...
def main():
    ...
    test_siege_availability_benchmark()  # siege -b: availability ≥99.5%, memory, hanging conns
